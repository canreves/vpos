...
from paynkolay_pos.testing import build_credential_matrix_json


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build a local/mock test matrix from credential CSV files.",
    )
    parser.add_argument(
        "--credentials-dir",
        type=Path,
    ...
    body = build_credential_matrix_json(
    ...
    print(f"Wrote credential matrix to {args.output}")
